...
public abstract class ObjectManager {
  ...
  // retrieve 'objTG' to which 'obj_shape' is attached
...
class RectangleBox extends ObjectManager { // make more classes like this
  ...
  public RectangleBox(Vector3d v) {
    ...
    a = MaterialManager.set_Appearance("./src/resources/middle.jpg"); // set the appearance for top of tile
  ...
  public RectangleBox(Vector3d v, float l, float h, float b) {
    ...
    Appearance a = new Appearance();
    // System.err.println(System.getProperty("user.dir"));
    a = MaterialManager.set_Appearance("./src/resources/tile3.jpg"); // set the appearance for top of tile
  ...
  protected Node create_Object(float l, float h, float b, Appearance a) {
    // System.err.println(System.getProperty("user.dir"));
    app = MaterialManager.set_Appearance("./src/resources/concrete.jpg");
    Appearance appTop = a;
  ...
  protected Node create_Object(float l, float h, float b) {
    ...
    // System.err.println(System.getProperty("user.dir"));
    appTop = MaterialManager.set_Appearance("./src/resources/ludo.jpg"); // set the appearance for the tower
    Box base = new Box(l, h, b, Primitive.GENERATE_TEXTURE_COORDS | Primitive.GENERATE_NORMALS, app);
    base.getShape(Box.TOP).setAppearance(appTop);
    return base;
  }
  ...
  protected Node create_Object(Appearance a) {
    ...
    stick = MaterialManager.set_Appearance("./src/resources/black.png");
    // first stick
